...
class ToastContainer extends Component {
  static propTypes = {
    containerStyle: Platform.OS === 'web' ? {} : ViewPropTypes.style,
    ...
    textStyle: Platform.OS === 'web' ? {} : Text.propTypes.style,
    mask: PropTypes.bool,
    maskColor: PropTypes.string,
    maskStyle: Platform.OS === 'web' ? {} : ViewPropTypes.style,
    imgSource: PropTypes.any,
    imgStyle: Platform.OS === 'web' ? {} : Image.propTypes.style,
      ...
      this.state.visible || this.animating ? (
        <View style={[styles.defaultStyle, position]} pointerEvents='box-none'>
          ...
          >
            ...
            {props.loading && (
              <ActivityIndicator color='#fff' size={props.indicatorSize} />
            )}
            {props.showText && (
              <Text
                style={[
